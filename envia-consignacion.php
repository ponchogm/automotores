...
<body>
  <p>Ha llegado una consulta sobre Consignación</p>
...
echo"<script type='text/javascript'>
            alert('Documento enviado exitosamente!');window.location.href=\"consignacion.html\"</script>";
?>